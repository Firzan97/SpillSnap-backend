...
const YA2025_FIELDS: ManualReliefField[] = [
  ...
  {
    key: 'epf',
    label: 'EPF / approved pension',
    hint: 'Mandatory or voluntary EPF contributions',
    group: 'financial',
    type: 'amount',
    cap: 4000,
  },
  {
    ...
    hint: 'Premiums or additional voluntary EPF',
    group: 'financial',
    type: 'amount',
    cap: 3000,
  },
  {
    ...
    hint: 'Private Retirement Scheme contributions',
    group: 'financial',
    type: 'amount',
    cap: 3000,
  },
  {
    key: 'edu_med_insurance',
    label: 'Education & medical insurance',
    hint: 'Premiums for self, spouse or child',
    group: 'financial',
    type: 'amount',
    cap: 4000,
  },
  {
    key: 'socso',
    label: 'SOCSO / PERKESO',
    hint: 'Your contribution for the year',
    group: 'financial',
    type: 'amount',
    cap: 350,
  },
  {
    key: 'sspn',
    label: 'SSPN net deposit',
    hint: 'Total deposits minus withdrawals this year',
    group: 'financial',
    type: 'amount',
    cap: 8000,
  },
  {
    ...
    hint: 'First home, S&P dated 2025 to 2027',
    group: 'financial',
    type: 'amount',
    cap: 7000,
  },
  ...
  },
  {
    ...
    hint: 'Spouse has no income, or you pay alimony',
    group: 'status',
    type: 'toggle',
    amount: 4000,
  },
  {
    ...
    hint: 'Your spouse is a registered OKU',
    group: 'status',
    type: 'toggle',
    amount: 6000,
  },
  ...
  {
    key: 'child_tertiary',
    label: 'Children 18+ in higher education',
    hint: 'Diploma and above, RM8,000 each',
    group: 'status',
    type: 'count',
    perUnit: 8000,
  },
  {
    ...
    hint: 'Registered OKU, RM8,000 each',
    group: 'status',
    type: 'count',
    perUnit: 8000,
  },
...
export function manualReliefFieldsForYa(ya: number): ManualReliefField[] {
  return (
    MANUAL_RELIEF_FIELDS_BY_YA[ya] ?? MANUAL_RELIEF_FIELDS_BY_YA[2025] ?? []
  );
}

/** Claimable RM a stored value contributes for a given field. */
export function manualClaimable(
  field: ManualReliefField,
  value: number,
): number {
